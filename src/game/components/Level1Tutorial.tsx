...
const STEPS: Step[] = [
  {
    icon: "🎮",
    title: "欢迎来到踹他一百下！",
    body: "你的目标是偷偷靠近老板，趁他不注意踹他 — 完成目标踹击数过关。",
    highlight: "注意：被老板发现会扣血，3 次扣血就 game over！",
  },
  {
    icon: "🕹️",
    title: "基础操作",
  ...
  },
  {
    icon: "👁️",
    title: "看懂老板状态",
    body: "右上角面板显示老板当前状态。绿色=安全（正常办公/手机响）；黄/橙色=警觉（回头看/被惊动）；红色=危险（巡逻中）。地面也会显示半透明扇形检测区。",
    highlight: "Boss 头顶的警觉度条满了会触发回头看！",
  },
  {
    icon: "🌿",
    title: "学会隐藏",
    body: "蹲在盆栽、书架、沙发旁可隐藏（状态显示「隐藏中」）。被老板回头看时立即躲进藏身点。",
  },
  {
    icon: "🧪",
    title: "善用道具",
    body: "道具会自动掉落。隐身药水免疫所有检测 5 秒；键盘盾被发现时只扣 0.5 血；加速鞋移动速度 x2；烟雾弹挡视线；噪音器吸引老板。",
  },
  {
    icon: "🎯",
    title: "完成踹击目标",
    body: "左下角显示踹击进度（如 0/10）。完成目标过关，可进入 FPS 彩蛋模式痛击老板 30 秒。零伤害零发现 = 3 星完美通关！",
    highlight: "现在去试试看 — 趁老板办公时绕到背后踹他！",
  },
];
